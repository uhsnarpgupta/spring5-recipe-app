package com.uhsnarp.spring5recipeapp.bootstrap;

import com.uhsnarp.spring5recipeapp.domain.*;
import com.uhsnarp.spring5recipeapp.repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        if (!americanCategoryOptional.isPresent()) {
            throw new RuntimeException("Expected Cateory Not Found");
        }
